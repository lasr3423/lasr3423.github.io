...
### 4.0.9 관리자 페이지 - QnA 관리

| 요구사항 ID | 기능명 | 설명 | 우선순위 | 관련 페이지 | 비고 |
| --- | --- | --- | --- | --- | --- |
|  | 질문 목록 | QnA 목록 | 🟠 중간 | /admin/qna/list | 상품의 이름 기재 |
|  | 질문 상세 | QnA 질문 상세 | 🟠 중간 | /admin/qna/{id} | 상품의 이름 기재 |
|  | 답변 등록 | QnA 질문의 답변 등록 | 🟠 중간 | /admin/qna/{id}/insert |  |
|  | 답변 수정 | 답변 내용 수정 | 🟠 중간 | /admin/qna/{id} |  |
|  | 답변 삭제 | soft delete 방식 삭제 | 🟢 낮음 | - | deleted_at 사용 |
...
| 요구사항 ID | 기능명 | 설명 | 우선순위 | 관련 페이지 | 비고 |
| --- | --- | --- | --- | --- | --- |
|  | 작성한 질문 목록 | 본인이 작성한 질문 목록 조회 | 🔴 높음 | /mypage/qna/list | 최신순 정렬 |
|  | 작성한 질문 상세 조회 | 질문 내용 답변 여부 상세 조회 | 🟠 중간 | /mypage/qna/{id} |  |
|  | 질문 수정 | 작성한 질문 내용 수정 | 🟠 중간 | /mypage/qna/{id} | updated_at 갱신 |
|  | 질문 삭제 | 작성한 질문 삭제 | 🟠 중간 | - | soft delete (deleted_at) |
