...
| v1.2 | 2026.03.28 | - | 토스페이먼츠 / 카카오페이 / 네이버페이 요구사항 신규 추가 |
...
### 4.7.1 결제 기능 (사용자) — 기존 Mock PG 기반

> 기존 REQ-PAY-001 ~ REQ-PAY-004는 유지됩니다.
...
| REQ-PAY-019 | 결제 수단별 라우팅 | payment.provider 기반으로 PG사별 클라이언트(TossGateway / KakaoGateway / NaverGateway) 라우팅 처리 | 🔴 높음 | - | PaymentGateway 인터페이스 구현 필수 |
